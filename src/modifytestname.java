...
public class modifytestname extends javax.swing.JFrame {
String name,tname;
    
    public modifytestname() {
        initComponents();
        this.setLocationRelativeTo(null);
    }
    public modifytestname(String name) {
        this.name=name;
        initComponents();
        this.setLocationRelativeTo(null);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String q="select tname from mcq where tname=? and lname=? and sln=1";
        try
        {
            st=mysqlconn.getConnection().prepareStatement(q);
            ...
            {   
                new modify(name,tname).setVisible(true);
                this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(modifytestname.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new modifytestname().setVisible(true);
            }
        });
    }
