 ...
 * @author KOTRESHA
 */
public class modifytestname1 extends javax.swing.JFrame {
String name,tname;
    /**
     * Creates new form modifytestname
     */
    public modifytestname1() {
        initComponents();
        this.setLocationRelativeTo(null);
    }
    public modifytestname1(String name) {
        this.name=name;
        initComponents();
        this.setLocationRelativeTo(null);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            {   
                new modifytest(name,tname,1).setVisible(true);
                this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(modifytestname1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new modifytestname1().setVisible(true);
            }
        });
    }
